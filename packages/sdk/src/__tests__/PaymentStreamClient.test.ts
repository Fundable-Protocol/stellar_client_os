...
describe('PaymentStreamClient', () => {
  ...
  describe('waitForTransaction', () => {
    ...
    it('throws when rpcUrl is not configured', async () => {
      const clientNoRpc = new PaymentStreamClient({
  ...
  describe('signAndWait', () => {
    const mockTxObj = { hash: 'def456', result: 2n, signAndSend: vi.fn() } as any;
    const waitResult = { hash: 'def456', ledger: 200, result: 2n };
