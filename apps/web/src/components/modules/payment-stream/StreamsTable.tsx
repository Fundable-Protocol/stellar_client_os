...
function StreamsTable({
    ...
    return (
        <div className="h-full flex flex-col space-y-4 overflow-y-auto pb-4">
            {/* Add overflow-x-auto container for horizontal scrolling on small viewports */}
            {/* The table wrapper from ui/table already has overflow-auto, but we need to ensure it works properly */}
            ...
            {totalCount > 0 && (
                <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
                    ...
                    <div className="flex items-center justify-center text-sm font-medium text-zinc-300" aria-live="polite" aria-atomic="true">
