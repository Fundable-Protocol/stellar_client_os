...
mod tests {
    ...
    fn test_propose_and_execute_action() {
        ...
        let action_hash = soroban_sdk::Bytes::from_array(&env, &[1u8; 32]);
        let desc = soroban_sdk::String::from_str(&env, "Upgrade contract");
